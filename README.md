...
<h3>시스템 사용법</h3>
   ...
   <br></br>
<h3>구현 내용</h3><br></br>
1. 지도에서 분리수거장 위치 바로 파악 가능<br></br>
   - 경북대학교 인근의 분리수거장 위치를 제공하여 사용자의 편의를 돕는다.<br></br>
<br></br>
2. 메인페이지에서 카메라 버튼으로 편리한 이미지 업로드 가능<br></br>
   - 웹사이트의 main에서 바로 이미지를 업로드할 수 있어 편리하다.<br></br>
<br></br>
3. 분리수거를 통해 모은 포인트로 상점에서 상품 교환<br></br>
   - 더 많은 사용자의 참여를 유도한다.<br></br>
     <br></br>
4. QnA 페이지에서 업데이트 내용 확인, 관리자와 컨택 가능<br></br>
<br></br>
7. 
